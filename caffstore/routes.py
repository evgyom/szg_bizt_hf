...
from caffstore.forms import UploadCAFFForm
# from flaskblog.forms import RegistrationForm, LoginForm, UpdateAccountForm, PostForm
from caffstore.models import CAFF, Comment
...
def home():
    ...
    return render_template('about.html', items=caffs, title='About')
...
def upload():
    ...
    if form.validate_on_submit():
        ...
        ### parse CAFF
        caff = CAFF(title=form.title.data, creator_name="sadasdas", duration=123, preview_file=CAFFname, CAFF_file=CAFFname)
        db.session.add(caff)
        db.session.commit()
